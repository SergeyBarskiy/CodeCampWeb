        ...
        var Utilities = (function () {
            function Utilities($window, globalsService) {
                ...
                var resize = function (event) {
                    ...
                    dialog.css("margin-top", (angular.element(that.$window).height() - dialog.height()) / 2 - parseInt(dialog.css("padding-top"), 10));
                };
                var animate = function (event) {
                    var dialog = angular.element("#" + event.data.name + " .modal-dialog");
                    dialog.css("margin-top", 0);
                    dialog.animate({
                        "margin-top": (angular.element(that.$window).height() - dialog.height()) / 2 - parseInt(dialog.css("padding-top"), 10)
                    }, "slow");
                ...
                this.showMessage = function (content, buttons) {
